...
def test_nyaa_search_no_results() -> None:
    results = client.search("akldlaskdjsaljdksd")
    assert tuple(results) == tuple()


def test_search_single() -> None:
